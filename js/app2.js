var GD = GD || {};
GD.GAME_STATE = {HOME: 0,PLAY: 1,OVER: 2};
GD.UNIT_TAG = {ENEMY: 100,PLAYER: 1E3,PET: 1010,BLOOD: 1020};
GD.ACTIVE_PETS = 0;
GD.ACTIVE_ENEMIES = 0;
GD.CONTAINER = {ENEMIES: [],BLOOD: [],BACKSKYS: [],HitMo: [],PET: [],BACKTILEMAPS: []};
GD.LIFE = 5;
GD.PETKIND = 0;
GD.SHOWLEVEL = 0;
GD.SCORE = 0;
...
GD.word = ["0", "1"];
var BitNumLayer = cc.Layer.extend({timeLabel: null,scoreLabel: null,time: null,timeAction: null,ctor: function() {
    this._super()
},step: function(a) {
    this.time += a
},init: function() {
...
var Light = cc.Sprite.extend({active: !1,ctor: function() {
...
Light.getOrCreate = function(a, b) {
    for (var e = null, d = 0; d < GD.CONTAINER.BLOOD.length; d++)
        if (e = GD.CONTAINER.BLOOD[d], !1 == e.active)
            return e.x = a, e.y = b, e;
    e = Light.create();
    e.x = a;
    e.y = b;
    return e
...
Light.preSet = function() {
    for (var a = null, b = 0; 1 > b; b++)
        a = Light.create(), a.visible = !1, a.active = !1
};
var Pet = cc.Sprite.extend({eID: 0,active: !0,direct: 1,isFire: !1,zOrder: 10,dieAction: null,liveAction: null,speed: 2,speedV: 15,rightsidex: 0,leftsidex: 0,speedY: 0,kind: 1,_zone: 100,state: 0,id: 0,_isEmpty: !0,ctor: function(a) {
    trace("addNewpet-----------" + a);
    ...
    var b = 10 * Math.floor(3 *
        Math.random()), e = cc.MoveTo.create(0.3, cc.p(this.x, this.pot[1] + 150)), b = cc.MoveTo.create(0.5, cc.p(this.x, this.pot[1] - b + 10)), d = cc.RotateBy.create(0.3, 360);
    this.running = !1;
    this.visible = !0;
    this.scaleX = -a;
    this.direct = -a;
...
Pet.getOrCreate = function(a) {
    ...
    for (var e = 0; e < GD.CONTAINER.PET.length; e++)
        if (b = GD.CONTAINER.PET[e], !0 == b._isEmpty && b.kind == a)
            return b;
    return Pet.create(a)
};
Pet.shared = function() {
    for (var a = [], b = [], e = [], d = "", c = 1; 8 > c; c++)
        d = "pet100" + (10 > c ? "0" + c : c) + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), a.push(d), d = "pet200" + (10 > c ? "0" + c : c) + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), b.push(d), d = "pet300" + (10 > c ? "0" + c : c) + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), e.push(d);
...
Pet.preSet = function() {
    for (var a = null, b = 0; 2 > b; b++)
        a = Pet.create(b + 1), a.visible = !1, a.active = !1
};
var Enemy = cc.Sprite.extend({eID: 0,active: !0,isLive: !0,aimX: 0,direct: 1,zOrder: 10,dieAction: null,liveAction: null,speed: 5,speedV: 15,rightsidex: 0,leftsidex: 0,showLevel: 0,showSpace: 0,hasFired: !1,speedY: 0,livenum: 1,kind: 1,power: 1,oric: null,ctor: function(a) {
    ...
    if (this.active) {
        a = this.x;
        var b = this.y;
        -50 < a && -1 == this.direct || a < winSize.width + 50 && 1 == this.direct ?
...
Enemy.addNewEnemy = function(a, b) {
    if (0 < this.showSpace)
        ...
        if (3 > b)
            Enemy.getOrCreateEnemy(a).toActive(e, 0);
        else {
            this.showSpace = 1;
            for (var d = 0; d < b; d++)
                Enemy.getOrCreateEnemy(a).toActive(e, d)
        }
    }
};
...
Enemy.shared = function() {
    for (var a = [], b = [], e = [], d = "", c = 1; 19 > c; c++)
        d = "npc100" + (10 > c ? "0" + c : c) + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), a.push(d), d = "npc200" + (10 > c ? "0" + c : c) + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), b.push(d), d = "npc300" + (10 > c ? "0" + c : c) + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), e.push(d);
...
Enemy.preSet = function() {
    for (var a = null, b = 0; 2 > b; b++)
        a = Enemy.create(b + 1), a.visible = !1, a.active = !1, a.stopAllActions(), a.unscheduleAllCallbacks()
};
var wxc_wan=0;var wxCount_177=new Object();var storage=window.localStorage;wxCount_177.v='wxCount_177';if(!window.localStorage){wxc_wan=-1;}wxCount_177.Load=function(){var s=storage[wxCount_177.v];return s;};wxCount_177.Save=function(t){storage[wxCount_177.v]=t;};wxCount_177.Clear=function(){storage.removeItem(wxCount_177.v);};var wxc_wan_s=wxCount_177.Load();if(isNaN(wxc_wan_s)){wxc_wan_s=1;}else{wxc_wan=parseInt(wxc_wan_s);wxc_wan+=1;}
var Helo = cc.Sprite.extend({eID: 0,active: !0,direct: 1,zOrder: 30,hurtAction: null,standAction: null,attactActionList: [],hasFired: !1,attactKind: 0,lock: !1,potList: [[-20, 19], [-80, 32], [-20, 40], [0, 0], [12, -6]],ctor: function() {
    ...
    for (var a = [], b = [], e = [], d = "", c = 10; 18 > c; c++) {
        var f = 14 < c ? 14 : c, d = "role00" + f + ".png", d = cc.spriteFrameCache.getSpriteFrame(d);
        a.push(d);
        d = "role00" + (f +
            5) + ".png";
    ...
    b = [];
    for (c = 1; 9 > c; c++)
        d = "role000" + c + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), b.push(d);
    this.standAction = cc.RepeatForever.create(cc.Animate.create(cc.Animation.create(b, 0.08)));
    this.standAction.retain();
    b = [];
    for (c = 25; 36 > c; c++)
        f = 34 < c ? 34 : c, d = "role00" + (10 > f ? "0" + f : f) + ".png", d = cc.spriteFrameCache.getSpriteFrame(d), b.push(d);
...
var HitMo = cc.Sprite.extend({active: !0,animation: null,addScoreLabel: null,bg: null,ctor: function() {
    this._super();
    ...
    this.actionMove = cc.MoveTo.create(0.3, cc.p(this.x,
        -130 + winSize.height / 2));
...
var MenuLayer = cc.Layer.extend({menu: null,ctor: function() {
    this._super()
},init: function() {
    this._super();
    centerPos = cc.p(winSize.width / 2, winSize.height / 2);
    var a = cc.Sprite.create(res.gameintro), b = cc.DrawNode.create();
    this.addChild(b, 0);
    ...
    var a = this, b = cc.EventListener.create({event: cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches: !1,onTouchBegan: function(b, d) {
        var c = d.getCurrentTarget(), f = c.convertToNodeSpace(b.getLocation()), c = c.getContentSize(), c = cc.rect(0, 0, c.width, c.height);
    ...
    //pgvSendClick({hottag: "act.minittxd.start"});
    cc.director.runScene(cc.TransitionFade.create(0.3, GameScene.create()))
}}), MenuScene = cc.Scene.extend({onEnter: function() {
    this._super();
    var a = new MenuLayer;
    a.init();
    this.addChild(a)
...
STATE_PLAYING = 0;
STATE_GAMEOVER = 1;
var g_sharedGameLayer, GameLayer = cc.Layer.extend({_size: 0,_helo: null,_heloB: null,_time: GD.MAXTIME,_midx: 0,_leftmidx: 0,_rightmidx: 0,_attactzone: [],_npcontainer: null,_introscene: null,_live: 0,_roles: null,_attackLeft: null,_attackRight: null,_dataLayer: null,_state: STATE_PLAYING,_hitUI: null,numLayer: null,_hitNum: 0,_liveBar: null,_barRenderer: null,_time2: 0,_others: null,_BtnColor: null,_space: 60,_barsize: [168, 17],_locktime: 3,ctor: function() {
    this._super()
},init: function() {
    if (this._super()) {
        this._space = 40;
    ...
    this._attackRight.scaleX = -1;
    var a = this, b = cc.EventListener.create({event: cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches: !1,onTouchBegan: function(b, d) {
        var c = d.getCurrentTarget(), f = c.convertToNodeSpace(b.getLocation());
        c.getContentSize();
    ...
    if (!(0 < this._locktime)) {
        this._locktime = 6;
        var b, e, d = this._helo.attactRect(), c = 1, f = !1;
        for (e = 0; e < GD.CONTAINER.ENEMIES.length; e++)
            if (b = GD.CONTAINER.ENEMIES[e], b.active && b.isLive && (b.x - this._midx < d.width && 1 == a && b.x > this._midx || this._midx - b.x < d.width && -1 == a && b.x < this._midx))
                b.toBeHurt(1), f = !0, Light.addNew(b.x, b.y), 0 == b.livenum && (GD.GETNUM += 1, c += b.kind, 1 < b.kind && Pet.addNew(b.x > this._midx ? 1 : -1));
    ...
    for (d = 0; d < GD.CONTAINER.ENEMIES.length; d++)
        if (b =
            GD.CONTAINER.ENEMIES[d], b.active && (b.update(a), b.isLive && !b.hasFired && (e = b.attactRect(), e.width + e.x > this._midx && 1 == b.direct || e.x - e.width < this._midx && -1 == b.direct)))
            b.hasFired = !0, this.checkPet(b) || (this._hitNum = 0, this.setLive(b.power), this._helo.beHurt(b.direct))
},checkPet: function(a) {
    if (0 < GD.CONTAINER.PET.length)
        for (var b = 0; b < GD.CONTAINER.PET.length; b++) {
            var e = GD.CONTAINER.PET[b];
            if (e && e.active)
                return e.toFire(a, a.x, a.y), !0
        }
    return !1
    ...
    this.init()
}}), GameScene = cc.Scene.extend({onEnter: function() {
    this._super();
    var a = new GameLayer;
    a.init();
    this.addChild(a)
...
var ShareLayer = cc.Layer.extend({_time: null,_bg: null,_scoreLabel: null,menu: null,listener4: null,ctor: function() {
    this._super()
},init: function() {
    this.initBg();
    this.initMenu();
    ...
    this.addChild(this.menu);
    var a = this;
    this.listener4 = cc.EventListener.create({event: cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches: !1,
        onTouchBegan: function(a, e) {
            var d = e.getCurrentTarget(), c = d.convertToNodeSpace(a.getLocation()), f = d.getContentSize(), f = cc.rect(0, 0, f.width, f.height);
    ...
    this.addChild(this._bg)
}}), ShareScene = cc.Scene.extend({onEnter: function() {
    this._super();
...
var GameOverLayer = cc.Layer.extend({_time: null,_bg: null,_scoreLabel: null,_sharelayer: null,_viewB: null,sharemenu: null,againmenu: null,downmenu: null,ctor: function() {
    this._super()
},init: function() {
    ...
    var a = this, b = cc.EventListener.create({event: cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches: !1,onTouchBegan: function(b,
                                                                                                                                  d) {
        var c = d.getCurrentTarget();
        trace(c);
        var f = c.convertToNodeSpace(b.getLocation()), g = c.getContentSize(), g = cc.rect(0, 0, g.width, g.height);
        if (cc.rectContainsPoint(g, f)) {
            c.y -= 2;
            if (c == a.sharemenu)
                a.onShare();
            else if (c == a.againmenu)
                a.onAgain();
            else if (c == a.downmenu)
                a.onDownLoad();
            return !0
        }
        return !1
...
}; /*  |xGv00|1439b86318e245c6f2b2ab42c42ab392 */
